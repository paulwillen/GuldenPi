...
mkdir /guldenserver
wget https://github.com/Gulden/gulden-official/releases/download/v2.0.0.1/Gulden-2.0.0.1-arm-linux-eabihf.tar.gz -P /guldenserver

tar -xvf /guldenserver/Gulden-2.0.0.1-arm-linux-eabihf.tar.gz -C /guldenserver/
