...
wget https://github.com/Gulden/gulden-official/releases/download/v2.2.0.7/Gulden-2.2.0.7-arm-linux-eabihf.tar.gz -P /guldenserver
echo "[$(date)] Download completed, now unpacking Gulden software" 
tar -xvf /guldenserver/Gulden-2.2.0.7-arm-linux-eabihf.tar.gz -C /guldenserver/
