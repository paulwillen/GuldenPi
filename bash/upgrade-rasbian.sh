...
wget https://github.com/Gulden/gulden-official/releases/download/v1.6.4.3/Gulden-1.6.4.3-arm-linux-eabihf.tar.gz -P /guldenserver
echo "[$(date)] Download completed, now unpacking Gulden software" 
tar -xvf /guldenserver/Gulden-1.6.4.3-arm-linux-eabihf.tar.gz -C /guldenserver/
